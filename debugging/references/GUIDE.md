...
This guide provides comprehensive documentation for the **debugging** skill in the custom-plugin-python plugin.
...
```bash
# Invoke the skill
claude "debugging - [your task description]"

# Example
claude "debugging - analyze the current implementation"
```
...
def implement_debugging(input_data):
    """
